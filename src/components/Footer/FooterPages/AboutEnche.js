    ...
    return (
        <>
            ...
            <div className='section_1_enche'>
                <Row className='section_1_enche_1'>
                    <div>
            ...
            <div className='secion_3_enche'>
                <Row>
                    <Col className='secion_3_enche_text'>
                        <div>
            ...
            <div className='section_6_enche'>
                <Row>
                    <Col><span className="fw-bold">Trustworthiness, Courage, Discipline, Diligence, and Loyalty</span> – At enche, all employees share five fundamental values to form the roots of company corporate culture. We are convinced that only in an environment shaped by these values can accentuate and develop services better, provide a positive outcome of solutions as well as obtain a well-grounded team of peers.</Col>
                    <Col>
