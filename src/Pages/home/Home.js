        ...
        <div className="container">
          <div className="banner_back row">
              ...
              <div className="">
                {categoryOption ? (
                  <div className="category_drop">
                    All products from banner option
                  </div>
                ) : null}
              </div>
            ...
            <div className="stores_row">
              ...
              <div className="col">
                <div className="stores_cart col-xl-12 col-lg-12 col-md-12">
                  {storesFiles?.map((item, key) => (
                    <div className="stores_cart_align" key={key}>
                      <div className="store_cart_img">
          ...
          <div className="container">
            <Row>
              <div className="col-xl-12 col-lg-12">
                ...
                <div className="charity_flex row">
                  {data?.map((item, key) => (
                    <div
                      className="exp_imgs col-xl-2 col-lg-2 col-md-4 col-sm-6"
                      key={key}
                    >
                      <img src={item?.img} alt="" />
                      <span>{item.label}</span>
        ...
        <div className="container">
          ...
          <div className="banner_div">
            <div className="bannerYellow d-flex">
              <div className="col-lg-8 col-md-7 col banner_resp">
                <div className="explore_card">
                  <div className="explore_head_text">
                    <div className="just_for">
                      <span className="before"></span> JUST FOR YOU
              ...
              <div className="col-lg-4 col-md-5 yello_Img">
                <img src={Images.seekpng} alt="" />
              </div>
            </div>
            <div className="explore_div">
              <Row>
                <div className="cards_box col-xl-12 col-lg-12">
                  {craftBox.map((item, key) => (
                    <div
                      className="explore_card col-xl-4 col-lg-4 col-md-4"
                      key={key}
                    >
